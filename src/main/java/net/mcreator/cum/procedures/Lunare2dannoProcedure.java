...
public class Lunare2dannoProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		CumMod.queueServerWork(15, () -> {
			if (entity.isAlive()) {
				...
				entity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.MOB_ATTACK)), (float) 7.5);
				CumMod.queueServerWork(15, () -> {
					if (entity.isAlive()) {
						{
							ItemStack _ist = itemstack;
						...
						entity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.MOB_ATTACK)), (float) 3.75);
					}
				});
			}
		});
