...
public class ProvettaConLiquidoOnBlockRightClickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == CumModItems.ECO_RI.get()) {
			{
			...
			if (entity instanceof Player _player) {
				ItemStack _stktoremove = new ItemStack(CumModItems.ECO_RI.get());
			...
			if (entity instanceof Player _player) {
				ItemStack _setstack = new ItemStack(CumModBlocks.PROVETTA_CON_LIQUIDO.get()).copy();
