...
public class MicropipettaRightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (!(new Object() {
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CumModBlocks.PROVETTA.get() && (new Object() {
			...
			}.getItemStack(0, itemstack)).getItem() == CumModItems.CAMPIONE_DI_DNA_FRAMMENTATO.get() && ((new Object() {
				public ItemStack getItemStack(int sltid, ItemStack _isc) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					_isc.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> {
						_retval.set(capability.getStackInSlot(sltid).copy());
				...
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = CumModBlocks.PROVETTA_CON_DNA_FRAMMENTATO.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
					for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
						Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
						if (_property != null && _bs.getValue(_property) != null)
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CumModBlocks.MATRICE.get() && (new Object() {
				public ItemStack getItemStack(int sltid, ItemStack _isc) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					_isc.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> {
						_retval.set(capability.getStackInSlot(sltid).copy());
				...
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = CumModBlocks.MATRICE_CON_DNA_FRAMMENTATO.get().defaultBlockState();
					BlockState _bso = world.getBlockState(_bp);
					for (Map.Entry<Property<?>, Comparable<?>> entry : _bso.getValues().entrySet()) {
						Property _property = _bs.getBlock().getStateDefinition().getProperty(entry.getKey().getName());
						if (_property != null && _bs.getValue(_property) != null)
			...
			if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CumModBlocks.PROVETTA_CON_LIQUIDO.get() && (new Object() {
				public ItemStack getItemStack(int sltid, ItemStack _isc) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					_isc.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> {
						_retval.set(capability.getStackInSlot(sltid).copy());
				...
				{
					ItemStack _isc = itemstack;
					final ItemStack _setstack = new ItemStack(CumModItems.CAMPIONE_DI_DNA.get()).copy();
					final int _sltid = 0;
					_setstack.setCount(1);
					_isc.getCapability(ForgeCapabilities.ITEM_HANDLER, null).ifPresent(capability -> {
						if (capability instanceof IItemHandlerModifiable itemHandlerModifiable) {
