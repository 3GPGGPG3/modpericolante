...
public class LunaDelGodoLivingEntityIsHitWithItemProcedure {
			...
			if (entity.isAlive()) {
				...
				CumMod.queueServerWork(15, () -> {
					if (entity.isAlive()) {
						...
						entity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(DamageTypes.MOB_ATTACK)), (float) 1.5);
					}
				});
			}
		});
