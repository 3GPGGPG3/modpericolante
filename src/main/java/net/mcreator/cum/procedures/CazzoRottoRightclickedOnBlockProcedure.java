...
public class CazzoRottoRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (Math.random() < 0.7) {
			...
			entity.hurt(new DamageSource(world.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("cum:rottura_di_minchia")))), 2);
		} else {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
