...
public class StatuaDiDemoneZannutoUsataBlockAddedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		CumMod.queueServerWork(5000, () -> {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = CumModBlocks.STATUA_DI_DEMONE_ZANNUTO.get().defaultBlockState();
