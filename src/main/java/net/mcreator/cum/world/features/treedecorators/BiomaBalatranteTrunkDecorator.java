...
public class BiomaBalatranteTrunkDecorator extends TrunkVineDecorator {
	public static Codec<BiomaBalatranteTrunkDecorator> CODEC = Codec.unit(BiomaBalatranteTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("bioma_balatrante_tree_trunk_decorator", DECORATOR_TYPE));
	}
