...
public class BiomaBalatranteFruitDecorator extends CocoaDecorator {
	public static Codec<BiomaBalatranteFruitDecorator> CODEC = Codec.unit(BiomaBalatranteFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("bioma_balatrante_tree_fruit_decorator", DECORATOR_TYPE));
	}

	public BiomaBalatranteFruitDecorator() {
		super(0.2f);
	}
