...
public class SecondafunzioneintegrazioneGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SecondafunzioneintegrazioneGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CumModMenus.SECONDAFUNZIONEINTEGRAZIONE_GUI.get(), id);
		...
		this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 47, 30) {
			private final int slot = 2;
			private int x = SecondafunzioneintegrazioneGUIMenu.this.x;
			private int y = SecondafunzioneintegrazioneGUIMenu.this.y;
		}));
		this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 122, 33) {
