...
public class ArmadiettoGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ArmadiettoGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CumModMenus.ARMADIETTO_GUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 7, 17) {
			...
			private int x = ArmadiettoGUIMenu.this.x;
			private int y = ArmadiettoGUIMenu.this.y;
		}));
