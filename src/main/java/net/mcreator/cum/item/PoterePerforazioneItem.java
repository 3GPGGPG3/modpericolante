...
public class PoterePerforazioneItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.cum.potere_perforazione.description_0"));
		list.add(Component.translatable("item.cum.potere_perforazione.description_1"));
		list.add(Component.translatable("item.cum.potere_perforazione.description_2"));
	}
