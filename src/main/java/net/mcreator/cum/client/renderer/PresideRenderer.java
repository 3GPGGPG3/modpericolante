...
public class PresideRenderer extends HumanoidMobRenderer<PresideEntity, HumanoidModel<PresideEntity>> {
	public PresideRenderer(EntityRendererProvider.Context context) {
		super(context, new HumanoidModel<PresideEntity>(context.bakeLayer(ModelLayers.PLAYER)), 0.5f);
