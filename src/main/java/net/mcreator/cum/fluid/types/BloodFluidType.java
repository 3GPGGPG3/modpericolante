...
public class BloodFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("cum:block/blood");
			private static final ResourceLocation FLOWING_TEXTURE = new ResourceLocation("cum:block/bloodflowing");
			...
			public Vector3f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector3f fluidFogColor) {
				return new Vector3f(0.2352941176f, 0f, 0f);
			}
