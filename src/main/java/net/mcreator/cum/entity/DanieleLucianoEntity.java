...
public class DanieleLucianoEntity extends Monster {
	public DanieleLucianoEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.DANIELE_LUCIANO.get(), world);
	}

	public DanieleLucianoEntity(EntityType<DanieleLucianoEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 58;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(CumModItems.BOLOGNESE_CON_L_UOVO.get()));
	}
