...
import net.mcreator.cum.procedures.GiocatoreIXOnInitialEntitySpawnProcedure;
import net.mcreator.cum.init.CumModEntities;

import javax.annotation.Nullable;

public class GiocatoreIXEntity extends Monster {
	public GiocatoreIXEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.GIOCATORE_IX.get(), world);
	}

	public GiocatoreIXEntity(EntityType<GiocatoreIXEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 2;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GiocatoreIXOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(CumModEntities.GIOCATORE_IX.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
