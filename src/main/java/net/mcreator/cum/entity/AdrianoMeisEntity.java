...
import net.mcreator.cum.procedures.AdrianoMeisEntityDiesProcedure;
import net.mcreator.cum.init.CumModEntities;

public class AdrianoMeisEntity extends Monster {
	public AdrianoMeisEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.ADRIANO_MEIS.get(), world);
	}

	public AdrianoMeisEntity(EntityType<AdrianoMeisEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 5;
		setNoAi(false);
		setCustomName(Component.literal("Adriano Meis"));
	...
	public void die(DamageSource source) {
		super.die(source);
		AdrianoMeisEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
