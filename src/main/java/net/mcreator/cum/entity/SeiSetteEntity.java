...
public class SeiSetteEntity extends Monster {
	...
	public SeiSetteEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.SEI_SETTE.get(), world);
	}

	public SeiSetteEntity(EntityType<SeiSetteEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.4f);
		xpReward = 0;
		setNoAi(false);
