...
public class ShrekEntity extends Monster {
	public ShrekEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.SHREK.get(), world);
	}

	public ShrekEntity(EntityType<ShrekEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(1f);
		xpReward = 5;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(CumModEntities.SHREK.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
