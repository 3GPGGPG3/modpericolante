...
public class GiocatoreXEntity extends Monster {
	public GiocatoreXEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.GIOCATORE_X.get(), world);
	}

	public GiocatoreXEntity(EntityType<GiocatoreXEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 30;
		setNoAi(false);
	...
	public static void init() {
		SpawnPlacements.register(CumModEntities.GIOCATORE_X.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
