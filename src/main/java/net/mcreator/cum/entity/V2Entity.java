...
public class V2Entity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED, ServerBossEvent.BossBarOverlay.PROGRESS);

	public V2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.V_2.get(), world);
	}

	public V2Entity(EntityType<V2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 100;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, V1Entity.class, false, false));
