...
public class DaveEntity extends Monster {
	...
	public DaveEntity(EntityType<DaveEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 4;
		setNoAi(false);
		...
		this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(Items.BUCKET));
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		DaveEntityIsHurtProcedure.execute(world, x, y, z, entity, sourceentity);
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(DaveEntity.this.getId());
					return new PVZshopMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
