...
import net.mcreator.cum.procedures.KingRatRightClickedOnEntityProcedure;
import net.mcreator.cum.init.CumModEntities;

public class KingRatEntity extends PathfinderMob {
	public KingRatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.KING_RAT.get(), world);
	}

	public KingRatEntity(EntityType<KingRatEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.4f);
		xpReward = 1;
		setNoAi(true);
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		KingRatRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
