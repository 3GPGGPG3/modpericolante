...
public class MirabellaEntity extends Monster {
	public MirabellaEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.MIRABELLA.get(), world);
	}

	public MirabellaEntity(EntityType<MirabellaEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 58;
		setNoAi(false);
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(CumModBlocks.PALO.get()));
	}
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(CumModBlocks.PALO.get()));
	}
		...
		if (sourceentity instanceof ServerPlayer serverPlayer) {
			NetworkHooks.openScreen(serverPlayer, new MenuProvider() {
				...
				public Component getDisplayName() {
					return Component.literal("Mirabella");
				}
				...
				public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
					...
					packetBuffer.writeVarInt(MirabellaEntity.this.getId());
					return new MiraGuiMenu(id, inventory, packetBuffer);
				}
			}, buf -> {
