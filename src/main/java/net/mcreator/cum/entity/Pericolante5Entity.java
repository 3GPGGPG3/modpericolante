...
public class Pericolante5Entity extends Monster {
	public Pericolante5Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.PERICOLANTE_5.get(), world);
	}

	public Pericolante5Entity(EntityType<Pericolante5Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 20;
		setNoAi(false);
		setCustomName(Component.literal("!!! 5 !!!"));
	...
	public static void init() {
		SpawnPlacements.register(CumModEntities.PERICOLANTE_5.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
