...
import net.mcreator.cum.procedures.GiocatoreXIOnInitialEntitySpawnProcedure;
import net.mcreator.cum.init.CumModItems;
import net.mcreator.cum.init.CumModEntities;

import javax.annotation.Nullable;

public class GiocatoreXIEntity extends Monster {
	public GiocatoreXIEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.GIOCATORE_XI.get(), world);
	}

	public GiocatoreXIEntity(EntityType<GiocatoreXIEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 30;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GiocatoreXIOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
