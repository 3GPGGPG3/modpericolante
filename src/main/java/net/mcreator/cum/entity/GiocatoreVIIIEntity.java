...
import net.mcreator.cum.procedures.GiocatoreVIIOnInitialEntitySpawnProcedure;
import net.mcreator.cum.init.CumModEntities;

import javax.annotation.Nullable;

public class GiocatoreVIIIEntity extends Monster {
	public GiocatoreVIIIEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.GIOCATORE_VIII.get(), world);
	}

	public GiocatoreVIIIEntity(EntityType<GiocatoreVIIIEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 2;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GiocatoreVIIOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}

	public static void init() {
		SpawnPlacements.register(CumModEntities.GIOCATORE_VIII.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
