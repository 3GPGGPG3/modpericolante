...
public class Pericolante6Entity extends Monster {
	public Pericolante6Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.PERICOLANTE_6.get(), world);
	}

	public Pericolante6Entity(EntityType<Pericolante6Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 40;
		setNoAi(false);
		setCustomName(Component.literal("!!! 6 !!!"));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(CumModItems.SPADA_SUPER_GODEVOLE.get()));
	}
	...
	public static void init() {
		SpawnPlacements.register(CumModEntities.PERICOLANTE_6.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
