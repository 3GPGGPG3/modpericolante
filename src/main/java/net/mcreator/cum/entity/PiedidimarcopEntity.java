...
public class PiedidimarcopEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(CumModItems.PIEDIDI_MARCO.get());

	public PiedidimarcopEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(CumModEntities.PIEDIDIMARCOP.get(), world);
	}

	public PiedidimarcopEntity(EntityType<? extends PiedidimarcopEntity> type, Level world) {
		super(type, world);
	}

	public PiedidimarcopEntity(EntityType<? extends PiedidimarcopEntity> type, double x, double y, double z, Level world) {
		super(type, x, y, z, world);
	}

	public PiedidimarcopEntity(EntityType<? extends PiedidimarcopEntity> type, LivingEntity entity, Level world) {
	...
	public static PiedidimarcopEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		PiedidimarcopEntity entityarrow = new PiedidimarcopEntity(CumModEntities.PIEDIDIMARCOP.get(), entity, world);
	...
	public static PiedidimarcopEntity shoot(LivingEntity entity, LivingEntity target) {
		PiedidimarcopEntity entityarrow = new PiedidimarcopEntity(CumModEntities.PIEDIDIMARCOP.get(), entity, entity.level());
