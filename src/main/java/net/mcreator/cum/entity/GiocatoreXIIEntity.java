...
import net.mcreator.cum.procedures.GiocatoreXIIOnInitialEntitySpawnProcedure;
import net.mcreator.cum.init.CumModItems;
import net.mcreator.cum.init.CumModEntities;

import javax.annotation.Nullable;

public class GiocatoreXIIEntity extends Monster {
	public GiocatoreXIIEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(CumModEntities.GIOCATORE_XII.get(), world);
	}

	public GiocatoreXIIEntity(EntityType<GiocatoreXIIEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 60;
		setNoAi(false);
	...
	public SpawnGroupData finalizeSpawn(ServerLevelAccessor world, DifficultyInstance difficulty, MobSpawnType reason, @Nullable SpawnGroupData livingdata, @Nullable CompoundTag tag) {
		...
		GiocatoreXIIOnInitialEntitySpawnProcedure.execute(this);
		return retval;
	}
