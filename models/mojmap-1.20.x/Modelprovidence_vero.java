...
public class Modelprovidence_vero<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "providence_vero"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition all = tutto.addOrReplaceChild("all", CubeListBuilder.create().texOffs(64, 32).addBox(-10.0F,
				-23.0F, 1.0F, 20.0F, 20.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition j = secondary_wings.addOrReplaceChild("j", CubeListBuilder.create(),
				PartPose.offset(-0.0224F, -5.5F, 1.0F));

		PartDefinition cube_r6 = j.addOrReplaceChild("cube_r6",
		...
		PartDefinition cube_r7 = f.addOrReplaceChild("cube_r7",
		...
		PartDefinition cube_r8 = h.addOrReplaceChild("cube_r8",
		...
		PartDefinition cube_r9 = i.addOrReplaceChild("cube_r9",
