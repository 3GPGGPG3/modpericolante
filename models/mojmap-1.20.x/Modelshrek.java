...
public class Modelshrek<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "shrek"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition gamba_dx = partdefinition.addOrReplaceChild("gamba_dx",
				CubeListBuilder.create().texOffs(0, 54)
						.addBox(-2.0F, -7.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 27)
						.addBox(-2.0F, 2.0F, -5.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition gamba_sx = partdefinition.addOrReplaceChild("gamba_sx",
				CubeListBuilder.create().texOffs(56, 0)
						.addBox(-2.0F, -7.0F, -1.0F, 4.0F, 11.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 33)
						.addBox(-2.0F, 2.0F, -5.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(4.0F, 20.0F, 1.0F));

		PartDefinition corpo = partdefinition.addOrReplaceChild("corpo",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-8.0F, -28.0F, -4.0F, 16.0F, 15.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(0, 27)
						.addBox(-7.0F, -13.0F, -3.0F, 14.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition braccio_sx = corpo.addOrReplaceChild("braccio_sx", CubeListBuilder.create().texOffs(46, 39)
				.addBox(-2.0F, -7.5F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(10.0F, -20.5F, 2.0F));

		PartDefinition braccio_dx = corpo.addOrReplaceChild("braccio_dx", CubeListBuilder.create().texOffs(30, 39)
				.addBox(-2.0F, -7.5F, -2.0F, 4.0F, 15.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-10.0F, -20.5F, 2.0F));

		PartDefinition testa = corpo.addOrReplaceChild("testa",
				CubeListBuilder.create().texOffs(0, 39)
						.addBox(-4.0F, -3.3243F, -1.4167F, 8.0F, 8.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(16, 54)
						.addBox(-1.0F, -0.3243F, -3.4167F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 54)
						.addBox(-2.0F, 0.6757F, -2.4167F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 19)
						.addBox(1.0F, 0.6757F, -2.4167F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -32.6757F, -0.5833F));

		PartDefinition cube_r1 = testa.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(56, 17).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 1.0F, 1.0F,
		...
		PartDefinition cube_r2 = testa.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(56, 15).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 1.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -1.2243F, 2.5833F, 0.0F, 0.0F, 0.3054F));
