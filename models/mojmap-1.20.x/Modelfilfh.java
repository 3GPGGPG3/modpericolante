...
public class Modelfilfh<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "filfh"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition testa = partdefinition.addOrReplaceChild("testa", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -8.0F, -3.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -1.0F));
		...
		PartDefinition gambadx = partdefinition.addOrReplaceChild("gambadx", CubeListBuilder.create().texOffs(24, 16)
				.addBox(-4.0F, -12.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition gambasx = partdefinition.addOrReplaceChild("gambasx", CubeListBuilder.create().texOffs(0, 32)
