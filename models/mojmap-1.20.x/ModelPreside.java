...
public class ModelPreside<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "preside"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition gambasinistra = partdefinition.addOrReplaceChild("gambasinistra", CubeListBuilder.create()
				.texOffs(0, 32).addBox(-4.0F, 11.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition testa = partdefinition.addOrReplaceChild("testa", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.0F, -8.0F, -1.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, -2.0F));
		...
		PartDefinition bracciodestro = partdefinition.addOrReplaceChild("bracciodestro", CubeListBuilder.create()
				.texOffs(16, 32).addBox(-8.0F, -24.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition gambadestra = partdefinition.addOrReplaceChild("gambadestra", CubeListBuilder.create()
				.texOffs(24, 16).addBox(-4.0F, -12.0F, -1.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
